...
class productClass:    
    def __init__(self,root):
        ...
        title=Label(product_Frame,text="Product Details",font=("goudly old style",15),bg="#0f4d7d",fg="white").pack(side=TOP,fill=X)

        lbl_category=Label(product_Frame,text="Category",font=("goudly old style",15),bg="white").place(x=30,y=60)
        lbl_supplier=Label(product_Frame,text="Supplier",font=("goudly old style",15),bg="white").place(x=30,y=110)
        lbl_product_name=Label(product_Frame,text="Name",font=("goudly old style",15),bg="white").place(x=30,y=160)
        lbl_price=Label(product_Frame,text="Price",font=("goudly old style",15),bg="white").place(x=30,y=210)
        lbl_quantity=Label(product_Frame,text="Quantity",font=("goudly old style",15),bg="white").place(x=30,y=260)
        lbl_status=Label(product_Frame,text="Status",font=("goudly old style",15),bg="white").place(x=30,y=310)
        ...
        SearchFrame=LabelFrame(self.root,text="Search",font=("goudy old style",12,"bold"),bd=4,relief=RIDGE,bg="white")
