...
class supplierClass:    
    def __init__(self,root):
        ...
        title=Label(self.root,text="Supplier Details",font=("goudly old style",20,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1000,height=40)

        #row1
        
        lbl_supplier_invoice=Label(self.root,text="Invoice No.",font=("goudly old style",15),bg="white").place(x=50,y=80)
        
        txt_supplier_invoice=Entry(self.root,textvariable=self.var_sup_invoice,font=("goudly old style",15),bg="light yellow").place(x=180,y=80,width=180)
        

        #row2

        lbl_name=Label(self.root,text="Name",font=("goudly old style",15),bg="white").place(x=50,y=120)
        
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudly old style",15),bg="light yellow").place(x=180,y=120,width=180)
        

        #row3

        lbl_contact=Label(self.root,text="Contact",font=("goudly old style",15),bg="white").place(x=50,y=160)
        
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudly old style",15),bg="light yellow").place(x=180,y=160,width=180)
        
        #row4

        lbl_desc=Label(self.root,text="Description",font=("goudly old style",15),bg="white").place(x=50,y=200)
        
        self.text_desc=Text(self.root,font=("goudly old style",15),bg="light yellow")
        ...
        self.supplierTable=ttk.Treeview(emp_frame,columns=("invoice","name","gender","contact","desc"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
